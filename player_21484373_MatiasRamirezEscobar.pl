...
Recorrido: Jugador
Descripción: Crea una representación de un jugador como una lista que contiene su ID, nombre, color de ficha, estadísticas (victorias, derrotas, empates) y el número de fichas restantes. Este predicado encapsula todos los datos relevantes de un jugador en una estructura compacta.
*/
...
%-------------------------------------------------------------
/* 
Predicado: update_stats/4
Tipo: Modificador
Dominio: EstadoJuego X Jugador1 X Jugador2 X NuevosJugadores
Recorrido: NuevosJugadores
Descripción: Actualiza las estadísticas de los jugadores al final de una partida, incrementando victorias, derrotas o empates según el resultado del juego.
*/
