...
main :-
	...
	player_play(G0, P1, 4, G1),    % Juan juega en columna 4
	player_play(G1, P2, 3, G2),    % Mauricio juega en columna 3
	...
	player_play(G6, P1, 5, G7),    % Juan juega en columna 5
	player_play(G7, P2, 3, G8),    % Mauricio juega en columna 3
	player_play(G8, P1, 6, G9),    % Juan juega en columna 6
	player_play(G9, P2, 3, G10),   % Mauricio juega en columna 3
	player_play(G10, P1, 7, G11),  % Juan juega en columna 7 (victoria horizontal)
